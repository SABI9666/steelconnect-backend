...
export class EstimationEngine {
    ...
    _initializeBaseRates() {
        return {
            concrete: {
                n20: { rate: 280, unit: "m³" }, n25: { rate: 300, unit: "m³" },
                n32: { rate: 320, unit: "m³" }, n40: { rate: 380, unit: "m³" },
                pumping: { rate: 25, unit: "m³", minimum: 800 }
            },
            reinforcement: {
                n12_bars: { rate: 2800, unit: "tonne" }, n16_bars: { rate: 2850, unit: "tonne" },
                n20_bars: { rate: 2900, unit: "tonne" }, n24_bars: { rate: 2950, unit: "tonne" },
                sl72_mesh: { rate: 8.50, unit: "m²" }, sl82_mesh: { rate: 9.20, unit: "m²" }
            },
            structural_steel: {
                "200 UB 22.3": { rate: 3.15, unit: "kg", weight_per_m: 22.3 }, "410 UB 53.7": { rate: 3.15, unit: "kg", weight_per_m: 53.7 },
                "310 UB 32": { rate: 3.15, unit: "kg", weight_per_m: 32.0 }, "250 UB 37.3": { rate: 3.15, unit: "kg", weight_per_m: 37.3 },
                "250 UB 25.7": { rate: 3.15, unit: "kg", weight_per_m: 25.7 }, "250 UB 31.4": { rate: 3.15, unit: "kg", weight_per_m: 31.4 },
                "310 UB 40.4": { rate: 3.15, unit: "kg", weight_per_m: 40.4 }, "200 UB 18.2": { rate: 3.15, unit: "kg", weight_per_m: 18.2 },
                "200 UB 25.4": { rate: 3.15, unit: "kg", weight_per_m: 25.4 }, "180 UB 16.1": { rate: 3.15, unit: "kg", weight_per_m: 16.1 },
                "410 UB 59.7": { rate: 3.15, unit: "kg", weight_per_m: 59.7 }, "360 UB 50.7": { rate: 3.15, unit: "kg", weight_per_m: 50.7 },
                "460 UB 67.1": { rate: 3.15, unit: "kg", weight_per_m: 67.1 }, "180 PFC": { rate: 3.25, unit: "kg", weight_per_m: 20.9 },
                "200 PFC": { rate: 3.25, unit: "kg", weight_per_m: 23.4 }, "150 PFC": { rate: 3.25, unit: "kg", weight_per_m: 17.0 },
                "230 PFC": { rate: 3.25, unit: "kg", weight_per_m: 27.6 }, "250 PFC": { rate: 3.25, unit: "kg", weight_per_m: 31.1 },
                "300 PFC": { rate: 3.25, unit: "kg", weight_per_m: 37.9 }, "380 PFC": { rate: 3.25, unit: "kg", weight_per_m: 48.2 },
                "100 X 100 X 9.0 SHS": { rate: 3.20, unit: "kg", weight_per_m: 25.8 }, "100 X 100 X 6.0 SHS": { rate: 3.20, unit: "kg", weight_per_m: 17.7 },
                "89 X 89 X 5.0 SHS": { rate: 3.20, unit: "kg", weight_per_m: 13.4 }, "150 X 150 X 9.0 SHS": { rate: 3.25, unit: "kg", weight_per_m: 38.5 },
                "150 X 150 X 6.0 SHS": { rate: 3.25, unit: "kg", weight_per_m: 26.6 }, "100 X 100 X 2.5 SHS": { rate: 3.20, unit: "kg", weight_per_m: 7.5 },
                "150 X 150 X 5.0 SHS": { rate: 3.25, unit: "kg", weight_per_m: 22.3 }, "150 X 150 X 3.0 SHS": { rate: 3.25, unit: "kg", weight_per_m: 13.6 },
                "150 X 150 X 4.0 SHS": { rate: 3.25, unit: "kg", weight_per_m: 18.0 }, "75 X 75 X 5.0 SHS": { rate: 3.20, unit: "kg", weight_per_m: 11.0 },
                "125 X 125 X 4.0 SHS": { rate: 3.20, unit: "kg", weight_per_m: 18.9 }, "100 X 100 X 5.0 SHS": { rate: 3.20, unit: "kg", weight_per_m: 14.9 },
                "125 X 125 X 5.0 SHS": { rate: 3.20, unit: "kg", weight_per_m: 23.4 }, "50 X 50 X 2 SHS": { rate: 3.20, unit: "kg", weight_per_m: 3.0 },
                "100 X 100 X 6 SHS": { rate: 3.20, unit: "kg", weight_per_m: 17.7 }, "150 X 50 X 9.0 SHS": { rate: 3.20, unit: "kg", weight_per_m: 31.0 },
                "200 X 100 X 5.0 SHS": { rate: 3.20, unit: "kg", weight_per_m: 28.0 }, "200 X 100 X 3.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 17.1 },
                "200 X 100 X 5.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 28.0 }, "150 X 50 X 4.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 15.0 },
                "125 X 75 X 3.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 11.4 }, "200 X 150 X 9.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 56.8 },
                "200 X 150 X 6.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 39.5 }, "250 X 150 X 5.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 38.0 },
                "200 X 100 X 6.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 33.1 }, "150 X 150 X 4.0 RHS": { rate: 3.25, unit: "kg", weight_per_m: 22.7 },
                "150 X 100 X 10.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 44.0 }, "200 X 100 X 9.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 47.0 },
                "200 X 50 X 6.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 28.0 }, "150 X 50 X 5.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 18.5 },
                "150 X 100 X 5.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 23.4 }, "150 X 100 X 10 RHS": { rate: 3.20, unit: "kg", weight_per_m: 44.0 },
                "150 X 50 X 6.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 22.0 }, "150 X 100 X 6.0 RHS": { rate: 3.20, unit: "kg", weight_per_m: 27.8 },
                "Z200 19": { rate: 3.10, unit: "kg", weight_per_m: 2.22 }, "Z250 24": { rate: 3.10, unit: "kg", weight_per_m: 3.03 },
                "Z200 15": { rate: 3.10, unit: "kg", weight_per_m: 1.74 }, "Z150 19": { rate: 3.10, unit: "kg", weight_per_m: 1.84 },
                "C20019": { rate: 3.10, unit: "kg", weight_per_m: 2.38 }, "C200 19": { rate: 3.10, unit: "kg", weight_per_m: 2.38 },
                "C150 19": { rate: 3.10, unit: "kg", weight_per_m: 1.93 }, "C100 15": { rate: 3.10, unit: "kg", weight_per_m: 1.22 },
                "C200 15": { rate: 3.10, unit: "kg", weight_per_m: 1.86 }, "250 UB": { rate: 3.15, unit: "kg", weight_per_m: 31.4 },
                "310 UB": { rate: 3.15, unit: "kg", weight_per_m: 40.4 }, "200 UB": { rate: 3.15, unit: "kg", weight_per_m: 25.4 },
                "180 UB": { rate: 3.15, unit: "kg", weight_per_m: 18.2 }, "410 UB": { rate: 3.15, unit: "kg", weight_per_m: 59.7 },
                "360 UB": { rate: 3.15, unit: "kg", weight_per_m: 50.7 }, "460 UB": { rate: 3.15, unit: "kg", weight_per_m: 67.1 }
            },
            fabrication: { simple: { rate: 800, unit: "tonne" }, medium: { rate: 1200, unit: "tonne" }, complex: { rate: 1800, unit: "tonne" } },
            treatment: { galvanizing: { rate: 800, unit: "tonne", minimum: 150 } },
            erection: { steel_erection: { rate: 650, unit: "tonne" } },
            anchors: { m12_mechanical: { rate: 35, unit: "each" }, m16_mechanical: { rate: 42, unit: "each" }, m20_mechanical: { rate: 55, unit: "each" } },
            formwork: { slab_formwork: { rate: 35, unit: "m²" }, beam_formwork: { rate: 65, unit: "m²" }, column_formwork: { rate: 85, unit: "m²" } },
            excavation: { general_excavation: { rate: 25, unit: "m³" }, backfill: { rate: 18, unit: "m³" } }
        };
    }
    ...
    async generateEstimation(analysisResult, location = "Sydney") {
        try {
            ...
            estimationItems.push(...await this._estimateConcreteWorks(quantities, location));
            estimationItems.push(...await this._estimateSteelWorks(quantities, location));
            estimationItems.push(...await this._estimateReinforcement(quantities, location));
            estimationItems.push(...await this._estimateMiscellaneousWorks(quantities, location));
            estimationItems.push(...await this._estimateProfessionalServices(analysisResult, location));
            ...
            // --- Safeguarded Final Object ---
            const estimationData = {
                project_id: analysisResult.projectId || 'unknown',
                items: Array.isArray(estimationItems) ? estimationItems.map(item => item.toObject()) : [],
                ...
                confidence_score: this._calculateConfidenceScore(estimationItems) || 0
            };
    ...
    async _estimateConcreteWorks(quantities, location) {
        ...
        if (!concreteQty.elements || !Array.isArray(concreteQty.elements)) return items;
        ...
        for (const element of concreteQty.elements) {
            ...
            if (volume > 0) {
                ...
                items.push(new EstimationItem({
                    code: `CON_${element.element_type?.toUpperCase()}_001`, description: `${element.element_type} concrete ${grade.toUpperCase()}`,
                    quantity: volume, unit: "m³", unitRate: concreteRate, totalCost: volume * concreteRate,
                    category: "Concrete", subcategory: element.element_type
                }));
                ...
                items.push(new EstimationItem({
                    ...
                    quantity: volume, unit: "m³", unitRate: pumpingCost / volume, totalCost: pumpingCost,
                    category: "Concrete", subcategory: "Pumping"
                }));
            }
        }
        return items;
    ...
    async _estimateSteelWorks(quantities, location) {
        ...
        if (!steelQty.members || !Array.isArray(steelQty.members)) return items;
        ...
        for (let i = 0; i < steelQty.members.length; i++) {
            ...
            if (!sectionDetails) {
                ...
                if (estimatedWeight > 0) {
                    ...
                    items.push(new EstimationItem({
                        ...
                        quantity: estimatedWeight, unit: "kg", unitRate: fallbackRate, totalCost: estimatedWeight * fallbackRate,
                        category: "Structural Steel", subcategory: "Supply", notes: "Estimated section - verify with supplier"
                    }));
                }
                continue;
            }
            ...
            if (finalWeightKg > 0) {
                ...
                items.push(new EstimationItem({
                    code: `STEEL_SUPPLY_${i + 1}`, description: `Structural Steel Supply - ${section}`,
                    quantity: finalWeightKg, unit: "kg", unitRate: supplyRate, totalCost: finalWeightKg * supplyRate,
        ...
        if (totalWeight > 0) {
            ...
            items.push(new EstimationItem({
                ...
                quantity: totalWeightTonnes, unit: "tonne", unitRate: fabRate, totalCost: totalWeightTonnes * fabRate,
            ...
            items.push(new EstimationItem({
                ...
                quantity: totalWeightTonnes, unit: "tonne", unitRate: erectionRate, totalCost: totalWeightTonnes * erectionRate,
            ...
            Object.entries(reinforcement.deformed_bars).forEach(([barType, weightKg]) => {
                ...
                if (weight > 0) {
                    ...
                    items.push(new EstimationItem({
                        ...
                        quantity: weightTonnes, unit: "tonne", unitRate: rate * locationFactor, totalCost: weightTonnes * rate * locationFactor,
                        category: "Reinforcement", subcategory: "Deformed Bars"
                    }));
                }
            });
        }
            ...
            Object.entries(reinforcement.mesh).forEach(([meshType, areaM2]) => {
                ...
                if (area > 0) {
                    ...
                    items.push(new EstimationItem({
                        ...
                        quantity: area, unit: "m²", unitRate: rate * locationFactor, totalCost: area * rate * locationFactor,
                        category: "Reinforcement", subcategory: "Mesh"
                    }));
                }
            });
        }
            ...
            Object.entries(misc.anchors).forEach(([anchorType, quantity]) => {
                ...
                if (qty > 0) {
                    ...
                    items.push(new EstimationItem({
                        ...
                        category: "Miscellaneous", subcategory: "Anchors"
                    }));
                }
            });
        }
    ...
    async _estimateProfessionalServices(analysisResult, location) {
        ...
        items.push(new EstimationItem({
            ...
            quantity: 1, unit: "LS", unitRate: engineeringRate * locationFactor, totalCost: engineeringRate * locationFactor,
            category: "Professional Services", subcategory: "Engineering"
        }));
        const pmRate = baseCost * 0.05;
        items.push(new EstimationItem({
            code: "PROF_PM_001", description: "Project Management",
            quantity: 1, unit: "LS", unitRate: pmRate * locationFactor, totalCost: pmRate * locationFactor,
            category: "Professional Services", subcategory: "Management"
        }));
        return items;
    }
    ...
    async _calculateCostSummary(items, location, riskAssessment) {
        ...
        return {
            base_cost: Math.round(baseCost * 100) / 100, location_factor: locationFactor,
            location_adjusted: Math.round(baseCost * 100) / 100, complexity_multiplier: complexityMultiplier,
            data_confidence_factor: dataConfidenceFactor, risk_adjusted: Math.round(riskAdjusted * 100) / 100,
            ...
            subtotal_ex_gst: Math.round(subtotalExGst * 100) / 100, gst: Math.round(gst * 100) / 100,
            total_inc_gst: Math.round(totalIncGst * 100) / 100, currency: 'AUD'
        };
    }
    ...
    _findSteelSectionDetails(sectionName) {
        ...
        for (const [key, details] of Object.entries(this.baseRates.structural_steel)) {
            if (getNormalizedKey(key) === cleanSectionKey) return details;
        }
    ...
    _generateAssumptions(analysisResult) {
        ...
        if (analysisResult && (analysisResult.confidence || 0) < 0.8) {
