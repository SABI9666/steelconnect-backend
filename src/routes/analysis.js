    ...
    try {
        ...
        res.json({
            ...
            usage: {
                ...
                storageAllowedMB: subscription.storageAllowedMB,
                storageUsedGB: ((subscription.storageUsedMB || 0) / 1024).toFixed(2),
                storageAllowedGB: subscription.storageAllowedMB ? (subscription.storageAllowedMB / 1024).toFixed(0) : null,
