...
router.post('/dashboards/upload', upload.single('spreadsheet'), async (req, res) => {
    try {
        const { contractorEmail, contractorName, frequency, title, description, googleSheetUrl } = req.body;
        ...
        res.json({
            success: true,
            message: hasFile ? 'Dashboard auto-generated from spreadsheet' : 'Google Sheet link saved for dashboard',
